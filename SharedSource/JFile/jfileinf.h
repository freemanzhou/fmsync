...
*		values for fields are stored in this area.  The structure of 
...
*		1) If there are no popup lists, sorts/advanced filters or default 

*			values, the memory chunk will consist of 4 null bytes.

*			

*		2) If there are popup lists, sorts/advanced filters, or default values, 
...
*	for the two seperator type strings that can be found in the 
...
#define		FLDTYPE_AUTODATE		0x0041		

#define		FLDTYPE_AUTOTIME		0x0042		

#define		FLDTYPE_AUTOINC			0x0043		

#define		FLDTYPE_BINARY			0x0044		

#define		FLDTYPE_CALC			0x0046		

#define		FLDTYPE_MODDATE			0x0049	

#define		FLDTYPE_MODTIME			0x0050	

#define		FLDTYPE_MULTLIST		0x0051		

#define 	FLDTYPE_FMSYNC_CHECKBOX	0x0052		



#define		FLDOPT_PROTECTED		0x8000		

#define		FLDOPT_HIDDEN			0x4000		



#define		FLDOPT_CLEAR			0x00ff	// utility mask for above settings

 

#define		CALC_ADD				0x0001

#define		CALC_SUBTRACT			0x0002

#define		CALC_MULTIPLY			0x0003

#define		CALC_DIVIDE				0x0004
